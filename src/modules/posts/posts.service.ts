...
export default class PostService {
  public async createPost(
    ...
    if (!user) throw new HttpException(400, "User id is not existed");
  ...
  public async updatePost(
    ...
    const updatePostId = await PostSchema.findByIdAndUpdate(
      postId,
      {
        ...postDto,
      },
  ...
  public async getAllPaging(
    ...
    const rowCount = await PostSchema.find(query)
